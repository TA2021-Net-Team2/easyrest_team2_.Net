...
namespace Team2.Net
{
    public class ModeratorPageTests : BaseTest
    {
        ...
        [Test(Description = "Moderator log in")]
        [AllureTag]
        ...
        [Test(Description = "Show apruved restaurant")]
        [AllureTag]
        [AllureOwner("Okhotynskyy")]
        ...
        [Test(Description = "Show unaproved restaurant")]
        [AllureTag]
        [AllureOwner("Okhotynskyy")]
        ...
        [Test(Description = "Disaproved restaurant")]
        [AllureTag]
        [AllureOwner("Okhotynskyy")]
        ...
        [Test(Description = "Disaproved archive restaurant")]
        [AllureTag]
        [AllureOwner("Okhotynskyy")]
        ...
        [Test(Description = "Show all users")]
        [AllureTag]
        [AllureOwner("Okhotynskyy")]
        ...
        [Test(Description = "Show all owners")]
        [AllureTag]
        [AllureOwner("Okhotynskyy")]
