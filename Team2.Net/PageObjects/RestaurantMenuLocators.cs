...
namespace Team2.Net.PageObjects
{
    public partial class RestaurantMenu
    {
        ...
        private static string TimePickerModalWindow = "//div[contains(@class, 'MuiDialogContent-root-1255 MuiPickersModal-dialog-1276')]";
        private static string ClockModalWindow = "//div[contains(@class, 'MuiPickersClock-squareMask')]";
        ...
        private readonly By TimePickerButtonLabel = By.XPath("//label[text()= 'Time picker']");
        ...
        private readonly By PickDay = By.XPath(DatePickerModalWindow + "//span[text()= '25']");
        private readonly By OKbutton = By.XPath(DatePickerModalWindow + "//span[text()= 'OK']");
        private readonly By TimeSelect = By.XPath(DatePickerModalWindow + "//div[@class='MuiPickersClock-squareMask-1435']");
        private readonly By SuccessTextDateSet = By.XPath("//p[contains (text(), 'Book time selected')]");
        private readonly By PickHour = By.XPath(ClockModalWindow + "//span[text()= '6']");
        private readonly By PickMinutes = By.XPath(TimePickerModalWindow + "//span[text()= '30']");
